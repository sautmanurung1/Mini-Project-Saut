...
func (r *repository) GetAssignmentById(id int, assign entities.Assignment) error {
	var user entities.User
...
func (r *repository) UpdateAssignment(id int, assignment entities.Assignment) error {
	var user entities.User
