...
// NewAssignmentRepository creates a new instance of AssignmentRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAssignmentRepository(t testing.TB) *AssignmentRepository {
