...
// NewAnswareRepository creates a new instance of AnswareRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAnswareRepository(t testing.TB) *AnswareRepository {
	mock := &AnswareRepository{}
	mock.Mock.Test(t)
