...
// NewAssignmentService creates a new instance of AssignmentService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAssignmentService(t testing.TB) *AssignmentService {
