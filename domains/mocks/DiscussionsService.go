...
// NewDiscussionsService creates a new instance of DiscussionsService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDiscussionsService(t testing.TB) *DiscussionsService {
	mock := &DiscussionsService{}
	mock.Mock.Test(t)
