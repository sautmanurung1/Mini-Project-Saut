...
// NewQuestionService creates a new instance of QuestionService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewQuestionService(t testing.TB) *QuestionService {
