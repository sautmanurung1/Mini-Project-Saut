...
// NewDiscussionsRepository creates a new instance of DiscussionsRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDiscussionsRepository(t testing.TB) *DiscussionsRepository {
	mock := &DiscussionsRepository{}
	mock.Mock.Test(t)
